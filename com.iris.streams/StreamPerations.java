...
public class StreamPerations {
    public static void main(String[] args) {
        ...
        //Male and Female employees in the  organisation
        Map<String, Long> noofmaleamdfemaleemployees = employeeList.stream().collect(Collectors.groupingBy(Employee::getGender, Collectors.counting()));
        System.out.println(noofmaleamdfemaleemployees);

        //Print the name of the department in the organisation
        ...
        // System.out.println(averagemaleandfemaleemployees);
